#ifndef RTM_LOGGING_H_
#define RTM_LOGGING_H_
...
#define Log_Debug(fmt, ...) logAtLevel(::rtm::util::kLogDebug, __FILE__, __LINE__, fmt, ##__VA_ARGS__)
#define Log_Info(fmt, ...) logAtLevel(::rtm::util::kLogInfo, __FILE__, __LINE__, fmt, ##__VA_ARGS__)
#define Log_Warn(fmt, ...) logAtLevel(::rtm::util::kLogWarn, __FILE__, __LINE__, fmt, ##__VA_ARGS__)
#define Log_Error(fmt, ...) logAtLevel(::rtm::util::kLogError, __FILE__, __LINE__, fmt, ##__VA_ARGS__)
#define Log_Fatal(fmt, ...) logAtLevel(::rtm::util::kLogFatal, __FILE__, __LINE__, fmt, ##__VA_ARGS__)
